...
<html class="no-js">
  <head>
    ...
    <!-- Js -->
    <!-- script begin -->
      <?php require_once"_/components/script.php";?>
    <!-- script end -->
  ...
  <body>
    <!-- Header Start -->
    <header>
       <?php require_once"_/components/header.php";?>
    </header><!-- header close -->
  ...
  <section id="feature">
    <div class="container">
      <div class="row">
        <div class="col-md-6 col-md-offset-6">
          ...
          <p>Maecenas faucibus mollis interdum. Morbi leo risus, porta ac consectetur ac, vestibulum at eros. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus.</p>
          <p>Maecenas faucibus mollis interdum. Morbi leo risus, porta ac consectetur ac, vestibulum at eros. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus.</p>
          <a href="_/components/work.php" class="btn btn-view-works">View Works</a>
        </div>
      </div>
    </div>
  </section>
    ...
    <!-- footer Start -->
    <footer>
       <?php require_once"_/components/footer.php";?>
    </footer>
